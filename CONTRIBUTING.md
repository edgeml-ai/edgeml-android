...
Please ensure your code passes both ktlint and SonarCloud checks before submitting a PR.
...
**Examples:**
```
feat: Add WorkManager integration for background training
fix: Resolve crash on TFLite model initialization
