...
import ai.octomil.tryitout.ModelInfo
import ai.octomil.tryitout.TryItOutScreen
import ai.octomil.tryitout.TryItOutViewModel
 ...
 *
 * When a model has been deployed via `octomil deploy --phone` and paired through
