...
import ai.octomil.api.dto.DeviceRegistrationResponse
import ai.octomil.api.dto.GradientUpdateRequest
import ai.octomil.api.dto.GradientUpdateResponse
import ai.octomil.api.dto.GroupMembershipsResponse
import ai.octomil.api.dto.HealthResponse
...
import ai.octomil.api.dto.SecAggMaskedInputRequest
import ai.octomil.api.dto.SecAggSessionResponse
import ai.octomil.api.dto.SecAggShareSubmitRequest
import ai.octomil.api.dto.SecAggShareSubmitResponse
import ai.octomil.api.dto.SecAggUnmaskRequest
import ai.octomil.api.dto.SecAggUnmaskResponse
import ai.octomil.api.dto.TrainingEventRequest
import ai.octomil.api.dto.VersionResolutionResponse
import ai.octomil.api.dto.WeightUploadRequest
...
/**
 * Retrofit API interface for Octomil server communication.
 *
 * All endpoints require authentication via API key in the header.
 */
interface OctomilApi {
    // =========================================================================
    // Health Check
    // =========================================================================
     ...
     * Replaces separate v1 telemetry and funnel endpoints.
     */
    ...
    suspend fun runDescriptive(
        ...
        @Body request: ai.octomil.analytics.DescriptiveRequest,
    ): Response<ai.octomil.analytics.DescriptiveResult>
    ...
    suspend fun runTTest(
        @Path("federation_id") federationId: String,
        @Body request: ai.octomil.analytics.TTestRequest,
    ): Response<ai.octomil.analytics.TTestResult>
    ...
    suspend fun runChiSquare(
        @Path("federation_id") federationId: String,
        @Body request: ai.octomil.analytics.ChiSquareRequest,
    ): Response<ai.octomil.analytics.ChiSquareResult>
    ...
    suspend fun runAnova(
        @Path("federation_id") federationId: String,
        @Body request: ai.octomil.analytics.AnovaRequest,
    ): Response<ai.octomil.analytics.AnovaResult>
    ...
    ): Response<ai.octomil.analytics.AnalyticsQueryListResponse>
    ...
    ): Response<ai.octomil.analytics.AnalyticsQuery>
    ...
    ): Response<ai.octomil.pairing.PairingSession>
    ...
    suspend fun connectToPairing(
        @Path("code") code: String,
        @Body request: ai.octomil.pairing.DeviceConnectRequest,
    ): Response<ai.octomil.pairing.PairingSession>
    ...
    suspend fun submitBenchmark(
        @Path("code") code: String,
        @Body report: ai.octomil.pairing.BenchmarkReport,
    ): Response<Unit>
