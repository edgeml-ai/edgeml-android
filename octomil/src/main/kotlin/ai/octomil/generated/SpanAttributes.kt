...
object SpanAttribute {
    ...
    const val KV_CACHE_STRATEGY = "kv_cache.strategy"
    const val KV_CACHE_QUANTIZATION_BITS = "kv_cache.quantization_bits"
    const val KV_CACHE_COMPRESSION_RATIO = "kv_cache.compression_ratio"
