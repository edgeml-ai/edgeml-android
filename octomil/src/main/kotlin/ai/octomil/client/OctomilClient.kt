...
import ai.octomil.api.dto.GroupMembership
...
import ai.octomil.secagg.SecAggManager
...
/**
 * Main entry point for the Octomil Android SDK.
 *
 ...
 *     .build()
 *
 * val client = OctomilClient.Builder(context)
 *     .config(config)
 *     .build()
 *
 ...
 * ```
 */
class OctomilClient private constructor(
    context: Context,
    private val config: OctomilConfig,
    private val ioDispatcher: CoroutineDispatcher = Dispatchers.IO,
    private val mainDispatcher: CoroutineDispatcher = Dispatchers.Main,
    private val api: OctomilApi = OctomilApiFactory.create(config),
    ...
    companion object {
        /** SDK version */
        val VERSION: String = BuildConfig.OCTOMIL_VERSION

        @Volatile
        private var instance: OctomilClient? = null
    ...
    suspend fun initialize(): Result<Unit> =
        withContext(ioDispatcher) {
            try {
                ...
                Timber.i("Initializing Octomil SDK v$VERSION")
                ...
                Timber.e(e, "Octomil initialization failed")
    ...
    /**
     * Register the device with the Octomil server.
     */
    ...
    fun predictStream(
        ...
        return kotlinx.coroutines.flow.flow {
            ...
            try {
                ...
                eventQueue.addTrainingEvent(
                    type = ai.octomil.sync.EventTypes.GENERATION_FAILED,
            ...
            eventQueue.addTrainingEvent(
                type = ai.octomil.sync.EventTypes.GENERATION_COMPLETED,
                metrics =
                    mapOf(
                        "ttfc_ms" to ttfcMs,
     ...
     * [OctomilConfig.allowDegradedTraining]:
    ...
    private fun buildGradientRequest(
        ...
        deviceId: String,
        roundId: String,
        trainingResult: ai.octomil.training.TrainingResult,
        isDegraded: Boolean,
    ): ai.octomil.api.dto.GradientUpdateRequest =
        ai.octomil.api.dto.GradientUpdateRequest(
            deviceId = deviceId,
            ...
            metrics = ai.octomil.api.dto.TrainingMetrics(
    ...
    private suspend fun uploadWithSecAgg(
        ...
        roundId: String,
        deviceId: String,
        trainingResult: ai.octomil.training.TrainingResult = ai.octomil.training.TrainingResult(0, null, null, 0.0),
    ...
    private fun checkReady() {
        ...
        require(currentState == ClientState.READY) {
            "Octomil client is not ready. Current state: $currentState. " +
    ...
    /**
     * Builder for creating OctomilClient instances.
     */
    class Builder(
        private val context: Context,
    ) {
        private var config: OctomilConfig? = null
        private var ioDispatcher: CoroutineDispatcher = Dispatchers.IO
        private var mainDispatcher: CoroutineDispatcher = Dispatchers.Main
        private var api: OctomilApi? = null
         ...
         */
        fun config(config: OctomilConfig) =
            apply {
                this.config = config
            }
        ...
        /** @hide */
        internal fun api(api: OctomilApi) = apply { this.api = api }
        ...
        /**
         * Build and return the OctomilClient instance.
         */
        fun build(): OctomilClient {
            ...
            val resolvedApi = api ?: OctomilApiFactory.create(cfg)
