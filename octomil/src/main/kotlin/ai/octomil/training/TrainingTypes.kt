...
/**
 * Result of the unified [ai.octomil.client.OctomilClient.train] method.
 *
...
data class TrainingOutcome(
     ...
     *
     * @see [ai.octomil.training.TFLiteTrainer.hasTrainingSignature]
     */
 ...
 * [OctomilConfig.allowDegradedTraining][ai.octomil.config.OctomilConfig.allowDegradedTraining]
...
class MissingTrainingSignatureException(
    ...
    // TEMP: training != modality; remap to TRAINING_NOT_SUPPORTED once contract codegen includes it
    ai.octomil.errors.OctomilErrorCode.UNSUPPORTED_MODALITY,
