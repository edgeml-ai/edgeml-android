...
/**
 * Secure storage for Octomil SDK using EncryptedSharedPreferences.
 *
...
class SecureStorage private constructor(
    ...
    companion object {
        private const val PREFS_FILE_NAME = "octomil_secure_prefs"
     ...
     */
    suspend fun getDevicePolicy(): ai.octomil.api.dto.DevicePolicyResponse? {
     ...
     */
    suspend fun setDevicePolicy(policy: ai.octomil.api.dto.DevicePolicyResponse) {
