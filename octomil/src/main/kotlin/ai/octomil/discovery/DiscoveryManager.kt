...
/**
 * High-level manager for making an Octomil device discoverable on the local network.
 *
 ...
 *     // Device is visible to `octomil deploy --phone`
 * }
 *
...
class DiscoveryManager(
     ...
     *
     * The device will be advertised as `Octomil-{deviceName}` with the given [deviceId]
