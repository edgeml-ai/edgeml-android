 ...
 *
 * Tracks model_id, model_version, artifact_version, installation status, and
 * which version is currently active (serving inference). Backed by a JSON file
 * on disk that persists across app restarts.
 */
class ArtifactMetadataStore(
    ...
    /**
     * Return the installed version string for [modelId], or null if nothing is active.
     */
