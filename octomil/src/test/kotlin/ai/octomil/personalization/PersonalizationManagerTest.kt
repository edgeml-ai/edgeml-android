package ai.octomil.personalization
...
import ai.octomil.training.TrainingResult
...
class PersonalizationManagerTest {
    ...
    @Before
    fun setUp() {
        filesDir = File(System.getProperty("java.io.tmpdir"), "octomil_pers_test_${System.nanoTime()}")
        filesDir.mkdirs()
