...
class EventQueueTest {
    ...
    @Before
    fun setUp() {
        queueDir = File(System.getProperty("java.io.tmpdir"), "octomil_test_queue_${System.nanoTime()}")
        queueDir.mkdirs()
    ...
    fun `createForTesting creates queue dir if needed`() {
        val newDir = File(System.getProperty("java.io.tmpdir"), "octomil_test_new_${System.nanoTime()}")
